...
const WineryExperience = () => {
  const { t } = useLocale();
  return (
    <section id="experience" className="relative overflow-hidden py-12 md:py-24 min-h-[500px] md:min-h-[850px]">
      <div className="absolute inset-0 bg-gradient-to-br from-cream-100/60 via-cream-100/20 to-cream-200/40" />
      <div className="absolute top-0 right-0 size-48 md:size-96 bg-wineRed-100/5 rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 size-36 md:size-72 bg-gold-100/10 rounded-full blur-3xl" />
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <div className="relative flex flex-col items-center justify-start -mt-12 md:-mt-24">
              <div className="absolute size-48 md:size-80 rounded-full bg-gradient-to-br from-wineRed-100/15 via-gold-100/10 to-transparent blur-2xl animate-pulse" />
              <div className="relative">
                <Image
                  src={ExperienceImage}
                  alt="Wine tasting experience at Kalchev Family Winery"
                  className="w-full object-contain h-[400px] md:h-[850px] drop-shadow-2xl mb-0 md:-mb-40"
                  width={447}
                  height={558}
