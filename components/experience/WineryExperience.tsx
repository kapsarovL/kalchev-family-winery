...
const WineryExperience = () => {
  const { t } = useLocale();
  return (
    <section id="experience" className="relative overflow-hidden py-16 md:py-24 min-h-[850px]">
      <div className="absolute inset-0 bg-gradient-to-br from-cream-100/60 via-cream-100/20 to-cream-200/40" />
      <div className="absolute top-0 right-0 size-96 bg-wineRed-100/5 rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 size-72 bg-gold-100/10 rounded-full blur-3xl" />

      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col lg:flex-row items-start gap-12">
          <div className="w-full lg:w-1/2 order-2 lg:order-1">
            <div className="inline-block px-4 py-1.5 bg-wineRed-100/10 rounded-full text-wineRed-100 text-sm font-medium mb-4">
            ...
            <Button
              size="lg"
              className="group bg-wineRed-100 hover:bg-wineRed-200 text-cream-100 px-8 py-6 text-base shadow-lg shadow-wineRed-100/20 hover:shadow-xl hover:shadow-wineRed-100/30 transition-all duration-300"
            >
              {t.experience.cta}
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <div className="relative flex flex-col items-center justify-start -mt-24">
              <div className="absolute size-80 rounded-full bg-gradient-to-br from-wineRed-100/15 via-gold-100/10 to-transparent blur-2xl animate-pulse" />
              <div className="relative">
                <Image
                  src={ExperienceImage}
                  alt="Wine tasting experience at Kalchev Family Winery"
                  className="w-full object-contain h-[850px] drop-shadow-2xl -mb-40"
                  width={447}
                  height={558}
