  ...
  return (
    <footer className="bg-deepBrown-200 text-white-100">
      ...
      <div className="border-t border-cream-100/10">
        <div className="container mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-3">
