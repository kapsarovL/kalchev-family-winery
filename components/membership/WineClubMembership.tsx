...
const WineClubMembership = () => {
  ...
  return (
    <section className="py-16 bg-white" id="wine-club">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-deep-brown/80 max-w-2xl mx-auto mb-4">
          ...
          <div className="flex items-center justify-center space-x-4 mt-8 mb-12">
            <span className="flex items-center text-deep-brown/70">
            ...
            >
              ...
              <CardContent className="text-center pb-6">
                <div className="mb-6">
                  ...
                  <span className="text-deep-brown/70 ml-1">
                    /{tier.billingPeriod}
                  </span>
                </div>
                <ul className="space-y-3 text-left">
                  {tier.features.map((feature, index) => (
                    <li key={index} className="flex items-start">
                      ...
                      <span className="text-deep-brown/90">{feature}</span>
                    </li>
                  ))}
                </ul>
              </CardContent>
        ...
        <div className="bg-cream/30 rounded-xl p-6 md:p-10 max-w-4xl mx-auto">
          <h3 className="text-2xl font-serif text-primary mb-4">
            Wine Club Benefits
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start">
              <div className="bg-gold-15 p-2 rounded-full mr-4">
                <GlassWater className="h-5 w-5 text-gold" />
              </div>
              <div>
            ...
            <div className="flex items-start">
              <div className="bg-wine-red-15 p-2 rounded-full mr-4">
                <Gift className="h-5 w-5 text-wine-red" />
              </div>
              <div>
                <h4 className="font-medium text-deep-brown mb-1">
                  Exclusive Access
            ...
            <div className="flex items-start">
              <div className="bg-deep-brown-15 p-2 rounded-full mr-4">
                <Calendar className="h-5 w-5 text-deep-brown" />
              </div>
              <div>
                <h4 className="font-medium text-deep-brown mb-1">
                  Member Events
            ...
            <div className="flex items-start">
              <div className="bg-cream p-2 rounded-full mr-4">
